...
import { HealthProfile, SocioEconomicProfile, HouseholdInfrastructure } from '@/lib/schemas/census';
...
export type Household = {
    ...
    // Legacy fields (will be migrated to infrastructure object eventually)
    ...
    // CENSUS ENRICHMENT
    infrastructure?: HouseholdInfrastructure;
    socioEconomic?: SocioEconomicProfile; // Aggregate profile for the HH
...
export type Resident = {
    ...
    idUrl?: string; // Link to uploaded ID
    selfieUrl?: string; // Link to selfie
};
...
export type User = {
    ...
    systemRole: 'Super Admin' | 'Encoder' | 'Viewer' | 'Responder' | 'Admin' | 'Resident'; // Defines the user's permission level in the system.
    email: string;
